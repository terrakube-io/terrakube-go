...
type Workspace struct {
	...
	Variables         []*Variable           `jsonapi:"relation,variable,omitempty"`
	History           []*History            `jsonapi:"relation,history,omitempty"`
	Schedules         []*WorkspaceSchedule  `jsonapi:"relation,schedule,omitempty"`
	Jobs              []*Job                `jsonapi:"relation,job,omitempty"`
	WorkspaceTags     []*WorkspaceTag       `jsonapi:"relation,workspaceTag,omitempty"`
	References        []*CollectionReference `jsonapi:"relation,reference,omitempty"`
	Access            []*WorkspaceAccess    `jsonapi:"relation,access,omitempty"`
}
